...
<ul class="y-header">
  ...
  <mt-index-list>
    <mt-index-section :index="item.initial" v-for="(item,index) in citys" :key="index" >
      <mt-cell :title="item.name" v-for="(item,index) in item.list " :key="index" @click.native="toMovie()"></mt-cell>
    </mt-index-section>
  </mt-index-list>
 </main>
</template>
...
export default {
  ...
  methods: {
    toMovie(){
       ...
       this.$router.push({name:'HotMovie'});
